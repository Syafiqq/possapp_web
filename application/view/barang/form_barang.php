<button id="play" data-toggle="tooltip" title="Play" type="button" class="btn btn-success btn-sm">
...
<script type="text/javascript" src="<?php echo base_url('js/DecoderWorker.js') ?>"></script>
<script type="text/javascript" src="<?php echo base_url('js/WebCodeCam.min.js') ?>"></script>
